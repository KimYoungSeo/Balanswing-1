...
public class CompareActivity extends AppCompatActivity {
    ...
    class MYView extends View {
        ...
        public void onDraw(Canvas canvas){
            ...
            canvas.drawRect(basex*2, basey*3, basex*4, basey*5, greenPaint);
            canvas.drawText("  왼발", basex*2, basey*2, linePaint);

            canvas.drawRect(basex*6, basey*3, basex*8, basey*8, greenPaint);
            canvas.drawText(" 오른발", basex*6, basey*2, linePaint);

            canvas.drawLine(basex*3, basey*5, basex*7, basey*8, blackPaint);
            canvas.drawCircle(basex*3,basey*5, basex/5,blackPaint);
            canvas.drawCircle(basex*7,basey*8, basex/5,blackPaint);
