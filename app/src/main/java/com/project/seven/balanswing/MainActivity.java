...
public class MainActivity extends AppCompatActivity {
    ...
    public class CDay{
        ...
        public CDay()
        {
            ...
            mLLDay.setLayoutParams(new ViewGroup.LayoutParams(GetPixelFromDP(50), GetPixelFromDP(50)));
            ...
            mTvDay.setLayoutParams(new ViewGroup.LayoutParams(GetPixelFromDP(15), ViewGroup.LayoutParams.WRAP_CONTENT));
            mTvDay.setGravity(Gravity.CENTER_VERTICAL);
            mTvDay.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
            mTvDay.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
